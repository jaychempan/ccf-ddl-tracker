    ...
    en: {
        ...
        pages: {
            home: {
                ...
                "home.preview.eyebrow": "Version 2.3",
            ...
            getIt: {
                ...
                "getIt.release.body": "The current stable release is v2.3, including manual card links, add-form draft restoration, minute-level countdowns by default, and clearer footer shortcuts.",
    ...
    zh: {
        ...
        pages: {
            ...
            getIt: {
                ...
                "getIt.release.body": "当前稳定版本为 v2.3，包含手动卡片链接、新增表单草稿恢复、默认分钟级倒计时和更清晰的底部快捷入口。",
