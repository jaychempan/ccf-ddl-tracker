...
const translations = {
    en: {
        ...
        pages: {
            home: {
                ...
                "meta.description": "CCF DDL Tracker is an open source Chrome extension for tracking CCF deadlines with a compact popup, time zone switching, import flow, and local-only storage.",
                "home.subtitle": "An open source Chrome extension for tracking CCF deadlines",
                "home.primaryCta": "Get Started",
                "home.preview.eyebrow": "Version 2.1",
                "home.preview.title": "Compact popup workflow for dense conference schedules",
                "home.preview.body": "The compact popup now adds v2.1 time zone controls, so manual deadlines can follow your selected display zone while imported conferences keep their source time data.",
                "home.preview.imageAlt": "Preview of the CCF DDL Tracker popup",
                "home.intro": "CCF DDL Tracker provides a compact popup for keeping deadlines visible in Chrome. You can add custom deadlines, import recommended conferences from CCFDDL, switch the display time zone, and keep everything stored locally in your browser.",
            ...
            getIt: {
                ...
                "getIt.release.body": "The current stable release is v2.1, including time zone switching and improved import time handling.",
    ...
    zh: {
        ...
        pages: {
            home: {
                "meta.title": "CCF DDL Tracker",
                "meta.description": "CCF DDL Tracker 是一个开源 Chrome 扩展，用紧凑弹窗、时区切换、本地存储和导入流程帮助你跟踪 CCF 截稿日期。",
                "home.subtitle": "一个用于跟踪 CCF 截稿日期的开源 Chrome 扩展",
                "home.primaryCta": "开始使用",
                "home.preview.eyebrow": "2.1 版本",
                "home.preview.title": "为密集会议日程设计的紧凑弹窗工作流",
                "home.preview.body": "紧凑 popup 在 v2.1 中新增了时区切换能力，手动添加的截止日期会按当前显示时区保存，导入会议则继续保留原始时间语义。",
                "home.preview.imageAlt": "CCF DDL Tracker 弹窗预览图",
                "home.intro": "CCF DDL Tracker 提供了一个紧凑弹窗，让你在 Chrome 中随时看到截稿信息。你可以手动添加自定义截止日期、从 CCFDDL 导入推荐会议、切换显示时区，并将所有数据只保存在当前浏览器本地。",
            ...
            getIt: {
                ...
                "getIt.release.body": "当前稳定版本为 v2.1，包含时区切换和导入时间处理增强。",
